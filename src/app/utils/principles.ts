...
export const principles = [
    ...
    },
    {
      ...
      description:
        'As above, so below; as below, so above. There is always a correspondence between the laws and phenomena of the various planes. By observing the world around us and within us, we are able to understand much that would be unknowable to us.',
      keywords: [],
    },
    {
      id: 3,
    ...
    },
    {
      ...
      description:
        "Everything is dual; everything has poles; everything has its pair of opposites. All manifested things have 'two poles' with varying degrees between the two extremes. To destroy an undesirable mental state, concentrate upon the opposite pole to that which you wish to suppress.",
      keywords: [],
    },
    {
      id: 5,
