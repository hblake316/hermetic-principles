...
const principles = [
  {
    ...
    keywords: ['Unknowable', 'Infinite', 'Eternal', 'Immutable', 'Spirit'],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    keywords: ['All truths are half-truths'],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    keywords: ['Causality', 'Consequence', 'Action', 'Reaction', 'Law'],
  },
  {
    id: 7,
    ...
    keywords: ['Gender', 'Creation', 'Generation', 'Masculine', 'Feminine'],
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {principles.map(principle => (
            <div
              key={principle.id}
              className="relative cursor-pointer perspective-1000 h-[400px]"
            ...
            >
              ...
              >
                {/* Front of card */}
                <div className="absolute w-full h-full bg-white border border-gray-200 rounded-lg shadow-lg p-6 flex items-center justify-center backface-hidden">
                ...
                {/* Back of card */}
                <div className="absolute w-full h-full bg-white border border-gray-200 rounded-lg shadow-lg p-6 rotate-y-180 backface-hidden">
                  <div className="flex flex-col h-full">
                    ...
                    <p className="text-sm font-[family-name:var(--font-source-serif)] text-blue-900 mb-4">
                    ...
                    <div className="mt-auto pt-3 border-t border-gray-200">
                      <div className="flex flex-wrap gap-2">
                        {principle.keywords.map((keyword, index) => (
                          <span
                            key={index}
                            className="px-2 py-1 bg-blue-50 text-blue-700 rounded-full text-xs font-[family-name:var(--font-source-serif)]"
                          >
                            {keyword}
                          </span>
                        ))}
