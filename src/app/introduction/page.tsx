  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 pb-16 max-w-4xl mx-auto">
      ...
      <p className="text-lg leading-relaxed text-center max-w-2xl font-[family-name:var(--font-source-serif)] mb-8">
        The Kybalion is a metaphysical text published in 1908 by the anonymous &ldquo;Three
        Initiates.&rdquo; It presents the Seven Hermetic Principles, timeless spiritual laws
        attributed to Hermes Trismegistus, a mythical figure said to be the origin of many wisdom
        traditions—combining Egyptian, Greek, and esoteric philosophy.
      </p>
